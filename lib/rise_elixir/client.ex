defmodule RiseElixir.Client do
  @moduledoc """
  ...
  **Params**: `route`, `args`
  ...
  RiseElixir.Client.get('/blocks', %{})
  # => { data, meta, links }
  """
  def get(route, args) do
    url = RiseElixir.build_url(route)
  ...
  **Params**: `route`, `args`
  ...
  RiseElixir.Client.post('/signatures', %{})
  # => { data, meta, links }
  """
  ...
  **Params**: `route`, `args`
  ...
  RiseElixir.Client.put('/node/status/forging', %{})
  # => { data, meta, links }
  """
